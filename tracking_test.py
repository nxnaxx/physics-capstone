...
while True:
  ...
  if tracking_start:
    ...
    if radius < origin + 70 and radius > origin - 30:
      if center_X > width / 2 + 150:
        motor.turn_right()
      elif center_X < width / 2 - 150:
        motor.turn_left()
      else:
        motor.forward_low()
    elif radius > origin + 70 and radius < origin + 150:
      motor.back()
    else:
      motor.stop()
    ...
    '''    
    elif radius < origin + 70 and radius > origin - 30:
      if center_X > width / 2 + 55:
        motor.turn_right()
      elif center_X < width / 2 + 55:
        motor.turn_left()
      else:
        motor.forward_low()
    '''
